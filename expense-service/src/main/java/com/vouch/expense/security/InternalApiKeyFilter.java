package com.vouch.expense.security;
...
// Internal-only endpoints (/api/expenses/internal/**) are marked permitAll() in
...
// path are sitting in this repo's public GitHub history (frontend/src calls
// each service's public URL directly, and the controller source is public
// too). This filter requires a shared secret header, set identically on
// every service via INTERNAL_API_KEY, on any request to an internal path --
// every other path passes through untouched, still gated by the normal JWT
// filter as before.
@Component
public class InternalApiKeyFilter extends OncePerRequestFilter {

    private static final String INTERNAL_PATH_PREFIX = "/api/expenses/internal/";
