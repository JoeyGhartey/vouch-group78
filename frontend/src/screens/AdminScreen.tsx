...
const createStyles = (c: ColorScheme) => StyleSheet.create({
  ...
  title: { color: c.dark, fontSize: 16, fontWeight: '700', fontFamily: fonts.bold },
  ...
  resolveBtnText: { color: c.buttonDarkText, fontSize: 14, fontWeight: '700', fontFamily: fonts.bold },
  ...
  emptyTitle: { fontSize: 16, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, marginTop: 12, marginBottom: 4 },
  ...
  modalTitle: { fontSize: 20, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, textAlign: 'center' },
  modalSub: { fontSize: 13, color: c.muted, textAlign: 'center', marginTop: 4, marginBottom: 16 },
  label: { fontSize: 12, color: c.muted, fontWeight: '600', fontFamily: fonts.semibold, marginTop: 12, marginBottom: 6 },
