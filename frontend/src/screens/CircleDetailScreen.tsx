...
const createStyles = (c: ColorScheme) => StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 18, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, textAlign: 'center', marginHorizontal: 12 },
  ...
  infoText: { fontSize: 15, fontWeight: '600', fontFamily: fonts.semibold, color: c.dark },
  ...
  tabText: { fontSize: 12, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted },
  ...
  memberAvatarText: { color: c.buttonDarkText, fontSize: 14, fontWeight: '700', fontFamily: fonts.bold },
  memberInfo: { flex: 1 },
  memberName: { fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold, color: c.dark },
  memberMeta: { fontSize: 11, color: c.muted, fontFamily: fonts.regular, marginTop: 2 },
  memberRight: { alignItems: 'center' },
  memberScore: { fontSize: 18, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark },
  memberScoreLabel: { fontSize: 9, color: c.muted, fontFamily: fonts.regular },
  creatorBadge: { backgroundColor: c.warningBgTint, borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, marginTop: 4 },
  creatorBadgeText: { fontSize: 9, fontWeight: '700', fontFamily: fonts.bold, color: c.accent },
  ...
  leaveBtnText: { color: c.danger, fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold },
  ...
  primaryBtnText: { color: c.buttonDarkText, fontSize: 14, fontWeight: '700', fontFamily: fonts.bold },
  ...
  loanAmount: { fontSize: 20, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark },
  statusBadge: { borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
  statusText: { fontSize: 10, fontWeight: '700', fontFamily: fonts.bold },
  loanReason: { fontSize: 13, color: c.muted, fontFamily: fonts.regular, marginBottom: 4 },
  loanParties: { fontSize: 12, color: c.muted, fontFamily: fonts.regular },
  loanInterest: { fontSize: 12, color: c.accent, fontFamily: fonts.regular, marginTop: 4 },
  ...
  expenseDesc: { fontSize: 16, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, flex: 1, marginRight: 8 },
  expenseAmount: { fontSize: 20, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark, textAlign: 'right' },
  expenseAmountRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  expenseMeta: { fontSize: 12, color: c.muted, fontFamily: fonts.regular },
  categoryBadge: { borderRadius: 20, paddingHorizontal: 10, paddingVertical: 3, alignSelf: 'flex-start', marginBottom: 8 },
  categoryBadgeText: { fontSize: 10, fontWeight: '700', fontFamily: fonts.bold },
  ...
  payerAvatarText: { color: c.buttonDarkText, fontSize: 9, fontWeight: '700', fontFamily: fonts.bold },
  expenseDate: { fontSize: 11, color: c.muted, fontFamily: fonts.regular },
  splitsContainer: { marginTop: 12, borderTopWidth: 1, borderTopColor: c.border, paddingTop: 12 },
  progressLabel: { fontSize: 11, color: c.muted, marginBottom: 6, fontWeight: '600', fontFamily: fonts.semibold },
  ...
  splitAvatarText: { fontSize: 11, fontWeight: '700', fontFamily: fonts.bold, color: c.dark },
  splitName: { fontSize: 13, color: c.dark, fontFamily: fonts.regular },
  splitAmount: { fontSize: 12, color: c.muted, fontFamily: fonts.regular, marginTop: 1 },
  settledBadge: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  settledText: { fontSize: 12, color: c.success, fontWeight: '600', fontFamily: fonts.semibold },
  settleBtn: { backgroundColor: c.accent, borderRadius: 8, paddingHorizontal: 14, paddingVertical: 6 },
  settleBtnText: { color: c.surface, fontSize: 12, fontWeight: '600', fontFamily: fonts.semibold },
  splitPending: { fontSize: 12, color: c.muted, fontStyle: 'italic' as const, fontFamily: fonts.regular },
  balancesCard: { backgroundColor: c.surface, borderRadius: 14, padding: 14, borderWidth: 1, borderColor: c.border },
  balancesTitle: { fontSize: 13, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, marginBottom: 10 },
  ...
  balanceKey: { fontSize: 13, color: c.muted, fontFamily: fonts.regular, flex: 1 },
  balanceAmount: { fontSize: 13, fontWeight: '700', fontFamily: fonts.bold, color: c.danger },
  ...
  insightHealthLabel: { fontSize: 11, color: c.slate400, fontWeight: '600', fontFamily: fonts.semibold, letterSpacing: 0.8 },
  healthBadge: { borderRadius: 999, paddingHorizontal: 20, paddingVertical: 8, marginTop: 10 },
  healthBadgeText: { fontSize: 26, fontWeight: '900', fontFamily: fonts.extrabold },
  ...
  categoryChartTitle: { fontSize: 14, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, alignSelf: 'flex-start', marginBottom: 4 },
  ...
  legendCategory: { flex: 1, fontSize: 13, color: c.dark, fontWeight: '600', fontFamily: fonts.semibold },
  legendPercent: { fontSize: 12, color: c.muted, fontFamily: fonts.regular, marginRight: 10, width: 36, textAlign: 'right' },
  legendAmount: { fontSize: 13, color: c.dark, fontWeight: '700', fontFamily: fonts.bold, width: 90, textAlign: 'right' },
  ...
  statCardLabel: { fontSize: 11, color: c.muted, fontFamily: fonts.regular, marginTop: 2 },
  emptyCard: { backgroundColor: c.surface, borderRadius: 14, padding: 28, alignItems: 'center', borderWidth: 1, borderColor: c.border },
  emptyTitle: { fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted, marginTop: 10 },
  modalBg: { flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'flex-end' },
  modal: { backgroundColor: c.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24 },
  modalTitle: { fontSize: 18, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, textAlign: 'center', marginBottom: 16 },
  ...
  cancelBtnText: { color: c.muted, fontSize: 14, fontFamily: fonts.regular },
  modalSub: { fontSize: 13, color: c.muted, fontFamily: fonts.regular, textAlign: 'center', marginTop: -10, marginBottom: 16 },
  ...
  disputeBadgeText: { fontSize: 10, fontWeight: '800', fontFamily: fonts.extrabold, color: c.danger },
  disputeDate: { fontSize: 12, color: c.muted, fontFamily: fonts.regular },
  disputeAmount: { fontSize: 20, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark, marginBottom: 12 },
  partiesRow: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 },
  partyItem: { flex: 1 },
  partyLabel: { fontSize: 11, color: c.muted, fontWeight: '600', fontFamily: fonts.semibold, marginBottom: 2 },
  partyName: { fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold, color: c.dark },
  divider: { height: 1, backgroundColor: c.border, marginBottom: 12 },
  reasonLabel: { fontSize: 11, color: c.muted, fontWeight: '600', fontFamily: fonts.semibold, marginBottom: 4 },
  reasonText: { fontSize: 14, color: c.dark, fontFamily: fonts.regular, marginBottom: 12, lineHeight: 20 },
  ...
  outcomeBtnText: { fontSize: 13, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted },
  ...
  memberDetailAvatarText: { color: c.buttonDarkText, fontSize: 24, fontWeight: '700', fontFamily: fonts.bold },
  memberDetailName: { fontSize: 18, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark, textAlign: 'center', marginBottom: 8 },
  memberRoleBadge: {
    flexDirection: 'row', alignItems: 'center', gap: 5,
    backgroundColor: c.surface, borderWidth: 1, borderColor: c.accent,
    borderRadius: 999, paddingHorizontal: 12, paddingVertical: 5,
  },
  memberRoleBadgeText: { fontSize: 11, fontWeight: '700', fontFamily: fonts.bold, color: c.accentDark, letterSpacing: 0.4 },
  memberScoreSection: { alignItems: 'center', paddingVertical: 20 },
  memberDetailScore: { fontSize: 40, fontWeight: '900', fontFamily: fonts.extrabold, color: c.dark },
  memberDetailScoreLabel: { fontSize: 11, color: c.muted, fontWeight: '700', fontFamily: fonts.bold, letterSpacing: 0.8, marginTop: 2 },
  ...
  memberPhoneText: { fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold, color: c.dark },
});
