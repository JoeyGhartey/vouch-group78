...
const createStyles = (c: ColorScheme) => StyleSheet.create({
  ...
  chartSectionLabel: { fontSize: 11, fontWeight: '700', fontFamily: fonts.bold, color: c.muted, letterSpacing: 1 },
  ...
  periodPillText: { fontSize: 10, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted },
  periodPillTextActive: { color: c.accentDark },
  chartTotalValue: { fontSize: 26, fontWeight: '900', fontFamily: fonts.extrabold, color: c.dark, marginTop: 4, marginBottom: 14 },
  chartCard: {
    backgroundColor: c.surface, borderRadius: 14, padding: 16,
    borderWidth: 1, borderColor: c.border, borderTopWidth: 3, borderTopColor: c.accent,
  },
  chartLabel: { fontSize: 13, fontWeight: '700', fontFamily: fonts.bold, marginBottom: 4 },
  tappedPoint: { fontSize: 12, fontWeight: '600', fontFamily: fonts.semibold, textAlign: 'center', marginTop: 6 },
  ...
  customBtnText: { fontSize: 12, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted },
  ...
  customInputText: { fontSize: 13, fontFamily: fonts.regular, textAlign: 'center' },
  ...
  iosPickerDoneText: { color: c.accent, fontWeight: '700', fontFamily: fonts.bold, fontSize: 14 },
  customEmptyState: { paddingVertical: 40, alignItems: 'center', justifyContent: 'center' },
  customEmptyText: { fontSize: 13, color: c.muted, fontFamily: fonts.regular, textAlign: 'center' },
  summaryMonth: { color: c.muted, fontSize: 13, fontWeight: '600', fontFamily: fonts.semibold, textAlign: 'center', marginBottom: 16, letterSpacing: 0.5 },
  ...
  summaryValue: { fontSize: 18, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark },
  summaryCurrency: { fontSize: 11, fontWeight: '500', fontFamily: fonts.medium, color: c.muted },
  summaryLabel: { fontSize: 11, color: c.muted, fontWeight: '600', fontFamily: fonts.semibold, marginTop: 4 },
  netRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'baseline', marginTop: 14, gap: 6 },
  netLabel: { fontSize: 12, color: c.muted, fontWeight: '600', fontFamily: fonts.semibold },
  netValue: { fontSize: 15, fontWeight: '800', fontFamily: fonts.extrabold },
  ...
  cardTitle: { fontSize: 14, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, marginBottom: 12 },
  manageSectionLabel: { fontSize: 12, fontWeight: '700', fontFamily: fonts.bold, color: c.muted, letterSpacing: 0.8, marginBottom: 10 },
  recapCard: {
  ...
  recapText: { fontSize: 14, color: c.dark, fontFamily: fonts.regular, lineHeight: 21 },
  recapHighlight: { fontWeight: '700', fontFamily: fonts.bold, color: c.dark },
  ...
  limitCat: { fontSize: 15, fontWeight: '800', fontFamily: fonts.extrabold, color: c.dark },
  limitAmt: { fontSize: 14, fontWeight: '700', fontFamily: fonts.bold, color: c.muted },
  limitBar: { height: 8, backgroundColor: c.border, borderRadius: 4, overflow: 'hidden' },
  limitFill: { height: '100%', borderRadius: 3 },
  limitSpentText: { fontSize: 12, color: c.muted, fontFamily: fonts.regular, marginTop: 6 },
  ...
  txInfo: { flex: 1 },
  txDesc: { fontSize: 14, fontWeight: '600', fontFamily: fonts.semibold, color: c.dark },
  txMeta: { fontSize: 11, color: c.muted, fontFamily: fonts.regular, marginTop: 2 },
  txAmt: { fontSize: 14, fontWeight: '800', fontFamily: fonts.extrabold },
  ...
  emptyTitle: { fontSize: 15, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, marginTop: 12, marginBottom: 4 },
  emptyText: { fontSize: 12, color: c.muted, fontFamily: fonts.regular, textAlign: 'center' },
  ...
  modalTitle: { fontSize: 20, fontWeight: '700', fontFamily: fonts.bold, color: c.dark, textAlign: 'center', marginBottom: 16 },
  ...
  typeText: { fontSize: 13, fontWeight: '600', fontFamily: fonts.semibold, color: c.muted },
  ...
  cancelText: { color: c.muted, fontSize: 14, fontFamily: fonts.regular },
  ...
  saveCategoryText: { fontSize: 12, color: c.dark, fontWeight: '600', fontFamily: fonts.semibold, flex: 1 },
  ...
  incomeBannerText: { fontSize: 13, color: '#16a34a', fontWeight: '600', fontFamily: fonts.semibold, flex: 1 },
});
