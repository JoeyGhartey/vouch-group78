            ...
            <View style={styles.summaryCard}>
              ...
              <View style={styles.summaryRow}>
                ...
                <View style={styles.summaryItem}>
                  ...
                  <Text style={[styles.summaryValue, { color: summary.netBalance >= 0 ? '#4CAF50' : '#e94560' }]}>
                ...
                {Object.entries(summary.categoryBreakdown)
                  ...
                  .map(([cat, amt]) => (
                    <View key={cat} style={styles.catRow}>
                      ...
                      <Text style={styles.catAmount}>GHS {(amt as number).toFixed(2)}</Text>
                    </View>
                  ))}
              </View>
            )}
                  ...
                  <View key={cat} style={styles.limitRow}>
                    ...
                    <View style={styles.limitBar}>
                      <View style={[styles.limitFill, {
                        ...
                        backgroundColor: (data as SpendingLimitData).exceeded ? '#e94560' : '#4CAF50',
                      }]} />
                    </View>
                    <Text style={[styles.limitText, (data as SpendingLimitData).exceeded && { color: '#e94560' }]}>
